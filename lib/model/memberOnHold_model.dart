...
class PostMemberOnHoldModel {
  ...
  factory PostMemberOnHoldModel.fromJson(Map<String, dynamic> json) => PostMemberOnHoldModel(
    ...
    data: json["data"] == null ? null : MemberOnHoldData.fromJson(json["data"]),
  );
...
class MemberOnHoldData {
  ...
  factory MemberOnHoldData.fromJson(Map<String, dynamic> json) => MemberOnHoldData(
    id: json["Id"],
    ...
    dateOfHolding: json["DateOfHolding"] == null ? null : DateTime.parse(json["DateOfHolding"]),
