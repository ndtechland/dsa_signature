                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: const Text("Membership & Approval Form",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 22,
                        color: Colors.white
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.dateOfJoining.toString()}",style: TextStyle(
                       ...
                       Expanded(
                         child: Padding(
                           ...
                           child: Container(
                             decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                             child: Text(
                               "${approvalFormController.getjobdetailbyidModel?.data?.member1Dob.toString()}",style: TextStyle(
                               fontSize: 17,fontWeight: FontWeight.w500,
                               //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.memberName2.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                             // decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.member2Dob.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.address.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.pincode.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.mobile2.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.email.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: TextButton(onPressed: (){Get.to(const ApprovalForm2());}, child: const Text("Next",style: TextStyle(
                          color: Colors.white,
                          fontSize: 15
                        ),)),
                      ),
