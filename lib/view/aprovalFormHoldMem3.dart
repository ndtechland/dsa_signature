...
class ApprovalFormHoldMem3 extends StatefulWidget {
  const ApprovalFormHoldMem3({super.key});

  @override
  State<ApprovalFormHoldMem3> createState() => _ApprovalFormHoldMem3State();
}

class _ApprovalFormHoldMem3State extends State<ApprovalFormHoldMem3> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Table(
                            ...
                            children:  [
                              ...
                              TableRow(children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.all(8.0),
                                  child: Text("${approvalFormHoldController.approvalFormModel?.data?.initialPayment.toString()}",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                              ...
                              TableRow(children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.all(8.0),
                                  child: Text("${approvalFormHoldController.approvalFormModel?.data?.modeOfPayment.toString()}",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                              ...
                              TableRow(children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.all(8.0),
                                  child: Text("${approvalFormHoldController.approvalFormModel?.data?.dateOfJoining.toString()}",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                        ...
                        Table(
                            ...
                            children:  [
                              ...
                              TableRow(children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.all(8.0),
                                  child: Text("${approvalFormHoldController.approvalFormModel?.data?.numberOfEmi.toString()}",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                        ...
                        Container(
                          ...
                          child: Text(
                            "${approvalFormHoldController.approvalFormModel?.data?.offerIncludeRemark.toString()}",
                          ),
                          // decoration: BoxDecoration(
                          //   border: Border.all(color: Colors.black,width: 1)
                          // ),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    "${approvalFormHoldController.approvalFormModel?.data?.repName.toString()}",style: TextStyle(
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Container(
                                  decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                                  child: Text(
                                    "${approvalFormHoldController.approvalFormModel?.data?.managerName.toString()}",style: TextStyle(
                                    fontSize: 17,fontWeight: FontWeight.w500,
                                    // decoration: TextDecoration.underline,
