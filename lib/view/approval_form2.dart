...
class ApprovalForm2 extends StatefulWidget {
  const ApprovalForm2({super.key});

  @override
  State<ApprovalForm2> createState() => _ApprovalForm2State();
}

class _ApprovalForm2State extends State<ApprovalForm2> {
                      ...
                      TableRow(
                          children: [
                            Container(
                             ...
                             Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text("${approvalFormController.getjobdetailbyidModel?.data?.apartment.toString()}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,),textDirection: TextDirection.ltr),
                            ),
                          ]
                      ),
                      TableRow(
                      ...
                      TableRow(
                          children: [
                            Container(
                             ...
                             Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text("${approvalFormController.getjobdetailbyidModel?.data?.tenure.toString()}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,),textDirection: TextDirection.ltr),
                            ),
                          ]
                      ),
                      TableRow(
                          children: [
                            Container(
                             ...
                             Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text("${approvalFormController.getjobdetailbyidModel?.data?.offerStayNights==null?"":approvalFormController.getjobdetailbyidModel?.data?.offerStayNights.toString()}/${approvalFormController.getjobdetailbyidModel?.data?.offerStayDays==null?"":approvalFormController.getjobdetailbyidModel?.data?.offerStayDays.toString()}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,),textDirection: TextDirection.ltr),
                            ),
                          ]
                      ),
                      TableRow(
                          children: [
                            Container(
                             ...
                             Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text("${approvalFormController.getjobdetailbyidModel?.data?.season.toString()}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,),textDirection: TextDirection.ltr),
                            ),
                          ]
                      ),
                    ],
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.amcAmount.toString()}",style: TextStyle(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.amcDueDate?.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.purchasePrice.toString()}",style: TextStyle(
                              fontSize: 17,fontWeight: FontWeight.w500,
                             // decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.adminCharges.toString()}",style: TextStyle(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.totalCost.toString()}",style: TextStyle(
                              fontSize: 18,fontWeight: FontWeight.w500,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.initialPayment.toString()}",style: TextStyle(
                              fontSize: 18,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            decoration: UnderlineTabIndicator(borderSide: BorderSide(color: Colors.black)),
                            child: Text(
                              "${approvalFormController.getjobdetailbyidModel?.data?.balance.toString()}",style: TextStyle(
                              fontSize: 18,fontWeight: FontWeight.w500,
                              //decoration: TextDecoration.underline,
